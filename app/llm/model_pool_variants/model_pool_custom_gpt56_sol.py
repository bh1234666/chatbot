"""Custom GPT-5.6 Sol model pool.

All named tasks route to gpt-5.6-sol through the GPT-5.5 provider config.
"""
...
THINK: dict[str, tuple[str, ProviderConfig]] = {
    "low": (CUSTOM_MODEL, GPT55),
    "mid": (CUSTOM_MODEL, GPT55),
    "high": (CUSTOM_MODEL, GPT55),
}
